...
//	the words backwards.
//	2.	The class will use a LinkedStack to reverse the order of the 
//	words.
...
public class ReverseOrder
{
	...
	protected LinkedStack<String> reverse;
	...
	{
		sen = sentance;
		reverse = new LinkedStack<String>();
		String result = "";
	...
	//-------------------------------------------------------------------
	// This method pops the stack clear by looping the size of the stack
	//-------------------------------------------------------------------
