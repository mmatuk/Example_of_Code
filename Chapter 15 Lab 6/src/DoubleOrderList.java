...
public class DoubleOrderList<T> extends DoubleList<T>
{
	...
	public void add(T element) throws Exception
	{
		...
		else
		{
			...
			// being checked
			while ((scan < count && current != null) && (element instanceof String
					? (((String)element).compareToIgnoreCase((String)current.getElement()) > 0)
					: comparableElement.compareTo(current.getElement()) > 0))
			{
				previous = current;
